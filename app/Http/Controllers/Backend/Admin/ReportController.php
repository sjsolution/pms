...
class ReportController extends Controller
{
    ...
    public function searchperiod(Request $request)
    {
        ...
        $end = Carbon::parse($toDate)->addDays(1)->toDateString();
        $property = PropertyRental::withTrashed()->whereBetween('created_at', [$start, $end])->with('room','charges')->withSum('paymenttrack','amount')->where(['building_id' => $building_id, 'property_rental' => 1])->get();
