                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            @if (Session::has('msg'))
                                <div class="col-md-12">
                                    <div class="alert alert-success mesg" style="margin-top: 5px">{{ Session::get('msg') }}</div>
                                </div>
                            @endif
                            ...
                            @foreach ($alerts as $item)
                                ...
                                <div class="alert {{$item['days'] < 0 ?  'alert-danger' : 'alert-warning'}} alert-dismissible fade show" role="alert">
                                    
                                    <strong>Your Document with title {{ $item['title'] }}  {{ $item['days'] < 0 ? 'has been expired before '.abs($item['days']) : 'will expire after '.$item['days'] }} days.</strong>
                                    <a href="{{route('admin.document.edit', $item['property']->id)}}"
...
@section('scripts')
    <script>
        ...
        window.setTimeout(function() {
            $(".mesg").fadeTo(500, 0).slideUp(500, function() {
                $(this).remove();
            });
        }, 2000);
