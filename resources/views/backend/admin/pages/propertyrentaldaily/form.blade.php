                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="board_type" class="form-control select2" id="">
                                                    ...
                                                    <option value="room_only" selected>Room Only</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#start_date').on('apply.daterangepicker', function(ev, picker) {
                ...
                var start_date = picker.startDate.format('DD/MM/YY');
                var enddate = picker.endDate.format('DD/MM/YY');
                ele('start_date').value = start_date;
                ele('end_date').value = enddate;
                
                var start_date = picker.startDate.format('MM/DD/YY');
                var enddate = picker.endDate.format('MM/DD/YY');
