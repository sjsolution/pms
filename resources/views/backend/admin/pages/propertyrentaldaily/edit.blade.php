                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <!--<input type="date" data-date="" data-date-format="DD MMMM YYYY" value="2015-12-29">-->
                                            <input type="date" data-date="" data-date-format="DD MMMM YYYY" min="{{ isset($propertyrental->end_date) ? date('Y-m-d', strtotime($propertyrental->end_date)) : date('Y-m-d') }}" id="end_date" name="end_date"
                                                value="{{ isset($propertyrental->end_date) ? date('Y-m-d', strtotime($propertyrental->end_date)) : '' }}"
                                                class="form-control" onchange="extend_date()" />
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="board_type" disabled class="form-control select2"
                                                    ...
                                                    <option value="room_only" {{ $propertyrental->board_type == 'room_only' ? 'selected' : '' }}>Room Only</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        const extend_date = () => {
            var start_date = "{{ date('Y-m-d', strtotime($propertyrental->start_date)) }}";

            var enddate = ele('end_date').value;
            ...
            // console.log(new Date(start_date), new Date(enddate))
            ...
            ele('total_days').value = parseInt(total);
        ...
        // window.onload = () => {
        //     console.log(12);
        //     var date = "{{ $propertyrental->start_date }}"
        //     $("#end_date").data('daterangepicker').setStartDate(date);
        //     // $("#reportrange").data('daterangepicker').setEndDate(endDate);
        // }
        // $(function() {
        //     var end_date = ele('end_date1').value;
